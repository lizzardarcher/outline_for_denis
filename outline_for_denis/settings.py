...
PASSWORD_RESET_DOMAIN = 'dom-vpn.su'
PASSWORD_RESET_ALLOWED_DOMAINS = ALLOWED_HOSTS
...
CELERITY_SERVER_GROUP_NAME = os.getenv('CELERITY_SERVER_GROUP_NAME', 'Марвел')
CELERITY_SERVER_GROUP_ID = os.getenv('CELERITY_SERVER_GROUP_ID') or None
...
ROBOKASSA_MERCHANT_LOGIN_BOT = os.getenv('ROBOKASSA_MERCHANT_LOGIN_BOT')
ROBOKASSA_PASSWORD_1_BOT = os.getenv('ROBOKASSA_PASSWORD_1_BOT')
ROBOKASSA_PASSWORD_2_BOT = os.getenv('ROBOKASSA_PASSWORD_2_BOT')

ROBOKASSA_MERCHANT_LOGIN_SITE = os.getenv('ROBOKASSA_MERCHANT_LOGIN_SITE')
ROBOKASSA_PASSWORD_1_SITE = os.getenv('ROBOKASSA_PASSWORD_1_SITE')
ROBOKASSA_PASSWORD_2_SITE = os.getenv('ROBOKASSA_PASSWORD_2_SITE')

CRYPTOBOT_API_KEY_SITE = os.getenv("CRYPTOBOT_API_KEY_SITE")
CRYPTOBOT_API_KEY_BOT = os.getenv("CRYPTOBOT_API_KEY_BOT")
